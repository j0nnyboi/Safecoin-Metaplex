...
export const CANDY_MACHINE_PROGRAM_ID = new PublicKey(
  'Fge8g9NWgysGk2FdqMFxWaZ8mNLWFZydRquWqVdSfh2N',
);
export const TOKEN_METADATA_PROGRAM_ID = new PublicKey(
  '9VDp1UoquCEaDs42go4ubDvzHBH4S4a295nDNuAXPvYm',
);
...
export const FAIR_LAUNCH_PROGRAM_ID = new PublicKey(
  'HNFJk792yXNPAkHu2ZJodk28mfoSttWX7TWd8FcPSYvR',
);
export const AUCTION_HOUSE_PROGRAM_ID = new PublicKey(
  '56gcEM7RFeoAvZzgdWLfhi53bdNPd4doTodaJHcn5pZt',
);
...
export const GUMDROP_DISTRIBUTOR_ID = new PublicKey(
  'HPh9XLtCU1LcMi3pSYBkptAZjkue1xKZ7MmzSDWiynKK'
);
