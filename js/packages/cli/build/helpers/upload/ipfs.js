        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ipfs = ipfs_http_client_1.create('https://ipfs.infura.io:5001');
                    ...
                    return [4 /*yield*/, uploadToIpfs(ipfs_http_client_1.globSource(image, { recursive: true }))];
                case 1:
                    mediaHash = _a.sent();
                    ...
                    return [4 /*yield*/, node_fetch_1.default("https://ipfs.infura.io:5001/api/v0/pin/add?arg=" + mediaHash, {
                            headers: {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, node_fetch_1.default("https://ipfs.infura.io:5001/api/v0/pin/add?arg=" + manifestHash, {
                            headers: {
                                Authorization: "Basic " + authIFPS,
                            },
                            method: 'POST',
