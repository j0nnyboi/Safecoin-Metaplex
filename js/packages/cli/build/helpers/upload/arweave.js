        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, result.safecoin * anchor.web3.LAMPORTS_PER_SOL];
            }
        });
    });
}
...
index) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var fsStat, estimatedManifestSize, storageCost, instructions, tx, data, result, metadataFile, imageFile, link, imageLink;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    tx = _c.sent();
                    loglevel_1.default.debug("safecoin transaction (" + env + ") for arweave payment:", tx);
                ...
                case 4:
                    ...
                    imageFile = (_b = result.messages) === null || _b === void 0 ? void 0 : _b.find(function (m) { return m.filename === 'image.png'; });
                    if (metadataFile === null || metadataFile === void 0 ? void 0 : metadataFile.transactionId) {
                        ...
                        imageLink = "https://arweave.net/" + imageFile.transactionId + "?ext=png";
