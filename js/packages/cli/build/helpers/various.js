...
exports.getPriceWithMantissa = exports.getMetadata = exports.generateRandoms = exports.chunks = exports.getMultipleAccounts = exports.parseDate = exports.parsePrice = exports.fromUTF8Array = exports.sleep = exports.getUnixTs = exports.generateRandomSet = exports.assertValidBreakdown = exports.shuffle = exports.readJsonFile = void 0;
...
var generateRandomSet = function (breakdown, dnp) {
    ...
    var _loop_1 = function () {
        ...
        keys.forEach(function (attr) {
            ...
            exports.assertValidBreakdown(formatted);
        ...
        keys.forEach(function (attr) {
            ...
            keys.forEach(function (otherAttr) {
                if (tmp[otherAttr] &&
                    ...
                    exports.assertValidBreakdown(breakdownToUse);
...
var getPriceWithMantissa = function (price, mint, walletKeyPair, anchorProgram) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                token = new safe_token_1.Token(anchorProgram.provider.connection, new anchor_1.web3.PublicKey(mint), safe_token_1.TOKEN_PROGRAM_ID, walletKeyPair);
