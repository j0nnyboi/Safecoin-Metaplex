...
async function getCandyMachineV2Config(walletKeyPair, anchorProgram, configPath) {
    ...
    const { storage, nftStorageKey, ipfsInfuraProjectId, number, ipfsInfuraSecret, awsS3Bucket, noRetainAuthority, noMutable, batchSize, price, splToken, splTokenAccount, solTreasuryAccount, gatekeeper, endSettings, hiddenSettings, whitelistMintSettings, goLiveDate, uuid, arweaveJwk, } = config;
    let wallet;
