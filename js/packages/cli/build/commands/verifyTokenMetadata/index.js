...
var verifyMetadataManifests = function (_a) {
    ...
    try {
        ...
        for (var manifestFiles_1 = __values(manifestFiles), manifestFiles_1_1 = manifestFiles_1.next(); !manifestFiles_1_1.done; manifestFiles_1_1 = manifestFiles_1.next()) {
            ...
            jsonschema_1.validate(tokenMetadata, token_metadata_schema_json_1.default, { throwError: true });
            var creators = tokenMetadata.properties.creators;
            exports.verifyAggregateShare(creators, manifestFile);
            exports.verifyCreatorCollation(creators, collatedCreators, manifestFile);
            ...
            exports.verifyImageURL(image, files_1, manifestFile);
        }
    }
    ...
    exports.verifyConsistentShares(collatedCreators);
};
...
var verifyTokenMetadata = function (_a) {
    ...
    exports.verifyAssets({ files: files, uploadElementsCount: uploadElementsCount });
    exports.verifyMetadataManifests({ files: files });
    return true;
};
