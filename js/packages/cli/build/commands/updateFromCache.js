...
function updateMetadataFromCache(candyMachineAddress, connection, wallet, batchSize, cacheContent, newCacheContent) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, signAll_1.getAccountsByCreatorAddress(candyMachineAddress, connection)];
                case 1:
                ...
                case 2:
                    ...
                    total += sliceAmount;
                    return [4 /*yield*/, signAll_1.delay(500)];
                case 3:
                    _a.sent();
            ...
            switch (_a.label) {
                case 0:
                    instructions = metadataList.map(function (meta) {
                        ...
                        var txnData = Buffer.from(borsh_1.serialize(schema_1.METADATA_SCHEMA, value));
                        return instructions_1.createUpdateMetadataInstruction(new web3_js_1.PublicKey(meta[1]), keypair.publicKey, txnData);
                    });
