...
programCommand('mint')
    ...
    const { keypair, env, url, collection, useMethod, totalUses, maxSupply, verifyCreators, } = cmd.opts();
    ...
    await (0, mint_nft_1.mintNFT)(solConnection, walletKeyPair, url, true, collectionKey, supply, verifyCreators, structuredUseMethod);
});
