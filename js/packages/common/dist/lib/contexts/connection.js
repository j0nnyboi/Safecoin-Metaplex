...
const safe_token_registry_1 = require("@j0nnyboi/safe-token-registry");
...
exports.ENDPOINTS = [
    ...
    },
    {
        ...
        chainId: safe_token_registry_1.ENV.Testnet,
    },
    {
        name: 'devnet',
        label: 'devnet',
...
function ConnectionProvider({ children }) {
    ...
    (0, react_1.useEffect)(() => {
        function fetchTokens() {
            return new safe_token_registry_1.TokenListProvider().resolve().then(container => {
