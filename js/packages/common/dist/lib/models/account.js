...
delegate, existingTransferAuthority) {
    ...
    instructions.push(safe_token_1.Token.createApproveInstruction(tokenProgram, account, delegate !== null && delegate !== void 0 ? delegate : transferAuthority.publicKey, owner, [], amount));
    if (autoRevoke) {
        cleanupInstructions.push(safe_token_1.Token.createRevokeInstruction(tokenProgram, account, owner, []));
    }
