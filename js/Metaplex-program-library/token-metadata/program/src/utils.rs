...
/// https://github.com/safecoin-labs/safecoin-program-library/tree/master/associated-token-account/program/src/processor.rs#L51-L98
#[inline(always)]
...
// IMPORTANT NOTE
// This allows the upgrade authority of the Token Metadata program to create metadata for safe tokens.
// This only allows the upgrade authority to do create general metadata for the safe token, it does not
...
pub fn process_create_metadata_accounts_logic(
    ...
    // IMPORTANT NOTE
    // This allows the Metaplex Foundation to Create but not update metadata for safe tokens that have not populated their metadata.
