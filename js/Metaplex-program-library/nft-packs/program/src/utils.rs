...
/// Initialize safe account instruction.
pub fn safe_initialize_account<'a>(
...
/// Initialize safe mint instruction
pub fn safe_initialize_mint<'a>(
    mint: AccountInfo<'a>,
