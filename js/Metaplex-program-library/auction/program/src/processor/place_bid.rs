...
pub fn place_bid<'r, 'b: 'r>(
    ...
    // Derive Pot address, this account wraps/holds an safe account to transfer tokens into and is
    // also used as the authoriser of the safe pot.
    ...
    if accounts.bidder_pot.data_is_empty() {
        ...
        // Attach safe token address to pot account.
        ...
        // Already exists, verify that the pot contains the specified safe address.
    ...
    // Confirm payers safe token balance is enough to pay the bid.
    ...
    // Transfer amount of safe token to bid account.
